...
Private Sub cmdListar_Click()
    ...
    Me.Caption = "Cadastro de Usuários" & " - Listando"
    MontaGrid
    ListarUsuarios
...
Private Sub cmdImprimir_Click()
    ...
    Printer.Print "Relatórios de usuários"
    ...
    For intLinhas = 1 To grdUsuarios.Rows - 1
    
        Printer.Print Space(5) & "ID: " & grdUsuarios.TextMatrix(intLinhas, 0)
        Printer.Print Space(5) & "Nome: " & grdUsuarios.TextMatrix(intLinhas, 1)
        Printer.Print Space(5) & "Email: " & grdUsuarios.TextMatrix(intLinhas, 2)
        Printer.Print Chr(13)
